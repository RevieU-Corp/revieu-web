...
export function MealDealCard({ image, title, price, oldPrice, description }: MealDealCardProps) {
      ...
      <div className="flex gap-4 p-3">
        ...
        <div className="flex-1 flex flex-col justify-between min-w-0">
          ...
          <div className="flex items-end justify-between gap-2">
            ...
            <button 
              onClick={handleOrder}
              className="bg-[#FFA500] hover:bg-[#FF8C00] active:scale-95 text-white px-4 py-1.5 rounded-lg text-sm font-semibold transition-all shadow-sm"
            >
              Order
            </button>
          </div>
