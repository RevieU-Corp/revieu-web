...
import { StudentPostProps } from '../types';
    ...
    >
      ...
      <div className="flex items-center gap-3 pt-2 border-t border-gray-100 mt-auto">
        <button
          ...
          className={`flex items-center gap-1.5 transition-colors group ${isLiked ? 'text-[#990000]' : 'text-gray-500 hover:text-[#990000]'
            }`}
        >
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-gray-500 hover:text-[#990000] transition-colors group"
        >
