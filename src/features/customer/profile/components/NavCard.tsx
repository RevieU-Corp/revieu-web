...
export const NavCard: React.FC<NavCardProps> = ({
  ...
  <div
    onClick={onClick}
    className="bg-white p-5 rounded-[24px] shadow-sm border border-gray-100 hover:shadow-[0_10px_30px_-10px_rgba(0,0,0,0.08)] transition-all cursor-pointer group relative overflow-hidden h-full flex flex-col justify-between min-h-[140px]"
  >
    ...
    <div className="flex justify-between items-start z-10">
      ...
      <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-gray-300 shadow-sm border border-gray-100 group-hover:text-brand-red group-hover:border-brand-red/20 transition-colors">
